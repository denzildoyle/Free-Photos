	...
	<body>
		<div class="container header">
			<div class="col-md-6 col-md-offset-3">
				<a class="logo" href="<?= base_url(); ?>" onClick="ga('send', 'event', 'text', 'click', 'Logo');"><h2 class="text-center">Free Food Photography</h2></a>
				...
				<p>We'll review your photo for publishing and if <a class="link" href="">your submission is accepted</a>, your work will be distributed for free under the <a class="link" href="<?= base_url() . "license" ?>" onClick="ga('send', 'event', 'link', 'click', 'license');">Free Food Photography license</a>.
