	...
	<body>
		<div class="container header">
			<div class="col-md-6 col-md-offset-3">
				...
				<p class="text-center"><b>Free (<a href="<?= base_url() . "public/" ?>license" class="gray"> do whatever you want </a>) high-resolution photos.</b> I take a lot of food photos and never really do anything with them, so here you go.</p>
			</div>
		</div>
		<div class="container">
			<div class="row">
			   	<?php foreach ($photos as $photo):?>
					<div class="col-lg-6 col-md-6 col-xs-12 thumb">
						<a href="<?= base_url() . "public/" ?>img/FFP_1.JPG"><img src="<?= base_url() . "public/img/preview/" . $photo['name'] . ".jpg" ?>" alt="<?= $photo['description']; ?>"></a>
					</div>
	          	<?php endforeach;?>
			</div>
		</div>
