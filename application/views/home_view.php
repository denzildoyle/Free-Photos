		...
		<div class="container">
			<div class="row">
			   	<?php foreach ($photos as $photo):?>
					<div class="thumb" <?php if($photo['id'] == 4) : ?> id="<?= $photo['id']; ?>" <?php endif; ?> >
						<?php if(!$photo['ad']) : ?>
