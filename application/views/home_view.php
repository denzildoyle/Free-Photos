	...
	<body>
		<div class="container header">
			<div class="col-md-6 col-md-offset-3">
				...
				<p class="text-center"><b>Free (<a href="<?= base_url() . "public/" ?>license" class="link"> do whatever you want </a>) high-resolution food photos.</b> I take a lot of food photos and never really do anything with them, so here you go.</p>
